...
public interface AccountRepository extends CrudRepository<Account, Integer> {
    ...
    @Modifying
    @Query(value = "INSERT INTO accounts(user_id, account_number, account_name, account_type,updated_at,create_at,balance) VALUES" +
            "(:user_id, :account_number, :account_name, :account_type,:updated_at,:create_at,:balance)",nativeQuery = true)
