...
function AccountForm({
  ...
  const handleDepositMoney = async (event) => {
    ...
    const apiUrl = "http://localhost:8070/transact/deposit";
  ...
  const handleWithdrawMoney = (event) => {
    ...
    const apiUrl = "http://localhost:8070/transact/withdraw";
  ...
  const handleTransferMoney = (event) => {
    ...
    const apiUrl = "http://localhost:8070/transact/transfer";
  ...
  const handlePaymentTransaction = (event) => {
    ...
    const apiUrl = "http://localhost:8070/transact/payment";
